...
export default {
  ...
  actions: {
    ...
    handleStatisticsCount({commit}, {st, et, subaccountNumber}) {
      return new Promise((resolve, reject) => {
        statisticsCount({
          st, et, subaccountNumber,
        }).then(res => {
    ...
    handleStatisticsList({commit}, {st, et, page, pageSize, subaccountNumber}) {
      return new Promise((resolve, reject) => {
        statisticsList({st, et, page, pageSize, subaccountNumber}
        ).then(res => {
    ...
    handleStatisticsDetailCount({commit}, {st, et, subaccountNumber}) {
      return new Promise((resolve, reject) => {
    ...
    handleStatisticsDetailList({commit}, {st, et, page, pageSize, subaccountNumber}) {
      return new Promise((resolve, reject) => {
        statisticsDetailList({st, et, page, pageSize, subaccountNumber}
        ).then(res => {
